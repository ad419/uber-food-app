  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F5F5F8]">
      <View className="items-center">
        ...
        <Text>{Object.entries(groupItemsInBucket).length}</Text>
      </View>
      ...
      <View className="px-8 space-y-1 mb-[100px] py-[20px] text-black bg-white">
        <View
          className="flex-row "
          style={{
        ...
        >
          <TouchableOpacity
            ...
            className="bg-[#F47B0A] justify-center items-center px-[111px] mt-[6px] py-[25px] rounded-2xl"
          >
